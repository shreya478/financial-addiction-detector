...
print(f"{'Epsilon':<8} | {'Tier':<12} | {'F1 Score':<8}")
print("-" * 35)

tiers = {0: 'Casual', 1: 'Frequent', 2: 'Compulsive', 3: 'Crisis'}

for eps in [1.0, 5.0, 10.0]:
    f1s = train_eval(X_train, y_train, X_test, y_test, eps)
    for i, f1 in enumerate(f1s):
        print(f"{eps:<8.1f} | {tiers[i]:<12} | {f1:.4f}")
    print("-" * 35)
